...
import { mat4, MAT4_IDENTITY, mat4Equals } from '../../mat4/mat4-core';
import { mat4Adjugate, mat4Invert, mat4Transpose } from '../../mat4/mat4-unary-ops';
import { mat4Multiply } from '../../mat4/mat4-binary-ops';
...
describe('mat4-unary-ops', function () {
    ...
    it('inverts invertible matrices', function () {
        ...
        expect(mat4Equals(id, MAT4_IDENTITY)).toBe(true);
