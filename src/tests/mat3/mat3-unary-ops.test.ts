...
import { mat3, MAT3_IDENTITY, mat3Equals } from '../../mat3/mat3-core';
import { mat3Adjugate, mat3Invert, mat3Transpose } from '../../mat3/mat3-unary-ops';
import { mat3Multiply } from '../../mat3/mat3-binary-ops';
...
describe('mat3-unary-ops', function () {
    ...
    it('inverts invertible matrices', function () {
        ...
        const inv = mat3();
        mat3Invert(inv, a);
        expect(mat3Equals(inv, mat3(-24, 18, 5, 20, -15, -4, -5, 4, 1))).toBe(true);

        const id = mat3();
        mat3Multiply(id, a, inv);
        expect(mat3Equals(id, MAT3_IDENTITY)).toBe(true);
