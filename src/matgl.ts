...
export const MatGL = {
     ...
     */
    projection(out: Matrix3x3, width: number, height: number): Matrix3x3 {
        // prettier-ignore
        return out.set(
            2 / width, 0, 0,
            0, -2 / height, 0,
     ...
     */
    perspective(out: Matrix4x4, fovy: number, aspect: number, near: number, far: number): Matrix4x4 {
     ...
     * @returns Matrix4x4 out
     */
    lookAt(out: Matrix4x4, eye: Readonly<Vector3>, center: Readonly<Vector3>, up: Readonly<Vector3>): Matrix4x4 {
        let x0, x1, x2, y0, y1, y2, z0, z1, z2, len;

        if (eye.equals(center)) {
            return out.fillWith(Matrix4x4.IDENTITY);
        }
